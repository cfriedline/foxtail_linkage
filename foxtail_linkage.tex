...
\begin{abstract}
  ...
  such as pines where genome size often exceeds $20$ to $30$ Gbp in size.
  ...
  tree species. We utilized megagametophyte arrays (\textit{n} $= 73 - 95$
  ...
  (\textit{n}$ = 23$ contigs/position), with an average spacing of $1.34$ ($\pm 0.50$) cM
