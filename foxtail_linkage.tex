...
\begin{abstract}
  ...
  such as pines where genome size often exceeds 20 to 30 Gbp in size. Here, we
  ...
  putative homology to loblolly pine.  Our results indicate that high density
  linkage maps can be produced efficiently for non-model forest tree species and
  that these maps have important functions as community-wide resources and as
  tools with which to test hypotheses about the genetic architecture of
  adaptation.
...
groups ($K$), moreover, did not change marker ordering within groups substantially.
