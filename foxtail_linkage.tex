...
A Mantel correlation was used to test the null hypothesis that  these distances were not correlated using a Bonferroni-corrected significance threshold of $\alpha = 0.05$. 
Separate tests were performed for each of the 12 linkage groups. All analysis was conducted in the R ver. 3.0.2 statistical computing environment.
...
of substitutions between two sequences \citep[2\textit{ut}, see][]{Nei:1987}, where the mutation rate (\textit{u}) was assumed 
to be $1.0$ x $10^{-9}$ substitutions/site/year and the divergence time (\textit{t}) was assumed to be $8.0$ x $10^{7}$ years 
\citep{Willyard:2007}. This translated into an average expectation of 16\% divergence
between homologous DNA sequences of loblolly and foxtail pines. We rounded down to 75\% to account for the variance
