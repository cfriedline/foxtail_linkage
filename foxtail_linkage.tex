...
\begin{figure}[ht]
\centering
\subfigure[Network of $n=30$ nodes\label{f:g1}]{\includegraphics[width=0.45\textwidth]{g1}}
\subfigure[Strongly connected subgraphs ($n=21$) of (A)\label{f:g2}]{\includegraphics[width=0.45\textwidth]{g2}}
...
uniquely by subgraph.  Edge stsyles vary to distinguish subgraphs with similar colors, and bar thickess 
indictaes the edge direction.}
\label{f:graphs}
\end{figure}
