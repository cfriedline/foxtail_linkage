...
\begin{figure}[ht]
\centering
\subfigure[Network of $n=30$ nodes\label{f:g1}]{\includegraphics[width=0.5\textwidth]{g1}}
\subfigure[Strongly connected subgraphs ($n=21$) of (A)\label{f:g2}]{\includegraphics[width=0.5\textwidth]{g2}}
