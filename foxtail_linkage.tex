...
To ensure that only SNPs that sort according to expected ratios were analyzed, we excluded SNPs using a 
$\chi^2$ test of homogeneity against an expectation of 1:1 segregation.
