...
Upon germination, haploid megagametophyte tissue was rescued from each seedling, cleaned (\textcolor{red}{how?}), and stored for further 
...
The LOD scores were used to construct pairwise distance matrix between all possible pairs of loci passing our quality thresholds.
...
cluster for the latter (\textcolor{red}{because...}).
...
\begin{figure}[t]
\centering
\subfigure[Bowtie 2 read mapping\label{f:assembly_perf}]{\includegraphics[width=0.7\textwidth]{mapping_performance}}
...
likelihood statistic for values of $k$ yielding assemblies compatible with this metric.}
