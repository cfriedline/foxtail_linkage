...
assembly was queried against the set of scaffolds comprising the loblolly pine genome using blastn. The top hit from each comparison was retained and these top
