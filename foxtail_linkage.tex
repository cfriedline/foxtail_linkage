...
\subfigure[Local alignment using Bowtie 2]{\includegraphics[width=0.72\textwidth]{mapping_performance}}\\
\subfigure[Log Average Proability (LAP)]{\includegraphics[width=0.72\textwidth]{lap_performance}}
