...
partial genes and 253 associated to whole genes.  We consider valid hits to the
genome assembly in regions that are not annotated (regardless of annotation
quality) as putatively non-genic. Therefore, of the \num{5627} contigs
containing SNPs, 94\% ($n=5288$) are in putatively non-genic regions of the
genome.
